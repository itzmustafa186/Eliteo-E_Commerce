...
export default function TrackOrderPage() {
  ...
  const handleTrack = async (e) => {
    ...
    try {
      // Detect whether the entered value is a phone number
          ...
          <div className="relative mx-auto max-w-7xl px-5 py-16 sm:py-20">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 max-w-xl text-sm leading-7 text-[#687080] sm:text-base">
                Enter your order number or phone number below to see the latest
          ...
          <div className="grid gap-8 lg:grid-cols-[1.25fr_0.75fr]">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-sm leading-6 text-[#7A808B]">
                    Enter your order number or phone number to continue.
                  </p>
                </div>
              </div>

              <form onSubmit={handleTrack} className="mt-9 space-y-5">
                {/* SEARCH */}
                ...
                <div>
                  ...
                  <p className="mt-2 text-xs text-[#9A9DA4]">
                    You can use either the order number or the phone number used
            ...
            <div className="rounded-[28px] bg-[#172033] p-7 text-white sm:p-9">
              ...
              <p className="mt-4 text-sm leading-7 text-white/60">
                We keep you informed at every important step of your delivery.
              </p>
              ...
              <div className="mt-8 space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-white/50">
                      Your order is handled carefully from dispatch to doorstep.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-white/50">
                      Your order information is kept secure throughout the
                      process.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-medium">Carefully Packed</h3>
                ...
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      <CheckCircle2 size={19} className="text-[#3D8B67]" />
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="hidden text-right sm:block">
                          <p className="text-xs text-[#A0A3A9]">Item Total</p>
